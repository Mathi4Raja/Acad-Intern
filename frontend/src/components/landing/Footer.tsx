        ...
        <footer className="border-t border-border/50 bg-card/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="py-6 md:py-8 flex flex-col items-center gap-4 md:gap-6">
                    ...
                    {/* Navigation Links */}
                    <nav className="flex flex-wrap items-center justify-center gap-x-4 md:gap-x-8 gap-y-1.5">
                    ...
                    <div className="flex items-center gap-3">
                        {socials.map((s) => (
                            <a
                                ...
                                href="#"
                                aria-label={s.name}
                                className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-muted/50 hover:bg-primary hover:text-primary-foreground flex items-center justify-center text-muted-foreground transition-all duration-300"
                            >
