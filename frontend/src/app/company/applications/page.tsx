      ...
      <ScheduleInterviewModal
        ...
        onSchedule={async (details) => {
          if (selectedAppForInterview) {
            await handleUpdateStatus(selectedAppForInterview, 'interview_scheduled', details)
          }
        }}
        studentName={applications.find(a => a.id === selectedAppForInterview)?.studentName || ''}
        position={applications.find(a => a.id === selectedAppForInterview)?.position || ''}
      />
    </div>
  )
}
