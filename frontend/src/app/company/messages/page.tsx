...
import { Search, ArrowLeft, MoreVertical, Phone, Video, Briefcase, Loader2 } from 'lucide-react'
        ...
        try {
            ...
            if (response.data.success) {
                const formatted: Conversation[] = response.data.data.map((conv: any) => ({
                    ...
                    participantRole: conv.participantRole === 'Student' ? 'Applicant' : conv.participantRole,
                    ...
                    {selectedConversation && currentConversation ? (
                        <>
                            ...
                            <div className="p-3 border-b border-gray-200 flex items-center justify-between bg-white">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                    ...
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center text-white font-semibold flex-shrink-0">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-xs text-gray-500 flex items-center gap-1 truncate">
                                            ...
                                            <span className="truncate">{currentConversation.participantRole}</span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="flex-1 flex items-center justify-center p-4">
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Applicant Messages</h3>
                                <p className="text-sm text-gray-500 max-w-sm">
                                    {conversations.length === 0
                                        ? "No conversations yet. Applicants will appear here when they message you!"
                                        : "Select a conversation to message applicants"
                                    }
                                </p>
                            </div>
                        </div>
